...
public class PropondoLanceSteps {
    ...
    //@Before e @After são chamados em todas classes Steps do Cucumber/?Selenium? != daqueles do JUnit.
    ...
    @Dado("um lance de {string} de {double} reais")
    public void um_lance_de_fulano_de_reais(String nomeUsuario, Double valor) {
